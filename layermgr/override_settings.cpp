...
#else
    QDir dir = QDir::home();
    if (!dir.cd("vulkan/implicit_layer.d")) {
        dir.mkpath("vulkan/implicit_layer.d");
        dir.cd("vulkan/implicit_layer.d");
    }
...
#else
    QDir dir = QDir::home();
    if (!dir.cd("vulkan/settings.d")) {
            dir.mkpath("vulkan/settings.d");
            dir.cd("vulkan/settings.d");
        }
